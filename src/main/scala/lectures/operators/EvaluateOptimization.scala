...
import lectures.functions.Computation.{computation, dataArray, filterData}
import lectures.functions.CurriedComputation.{dataArray, partiallyAppliedCurriedFunction}
import lectures.functions.FunctionalComputation.{dataArray, filterApplied}
